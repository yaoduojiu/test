<template>
  <a-card :bordered="false">
      ...
      <a-form layout="inline" @keyup.enter.native="searchQuery">
        <a-row :gutter="24">
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="投料订单号">
              <a-input placeholder="请输入投料订单号" v-model="queryParam.code"></a-input>
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="主原材料编码">
              <a-input placeholder="请输入主原材料编码" v-model="queryParam.materialCode"/>
            </a-form-item>
          </a-col>
          <template v-if="toggleSearchStatus">
            <a-col :xl="6" :lg="7" :md="8" :sm="24">
              <a-form-item label="主原材料名称">
                <a-input placeholder="请输入主原材料名称" v-model="queryParam.materialName"></a-input>
              </a-form-item>
            </a-col>
            <a-col :xl="6" :lg="7" :md="8" :sm="24">
            ...
            <a-col :xl="6" :lg="7" :md="8" :sm="24">
              <a-form-item label="产线名称">
                <j-dict-select-tag placeholder="请选择产线名称" v-model="queryParam.lineId" dictCode="line,line_name,id"/>
              </a-form-item>
            </a-col>
          </template>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" @click="handleExportXls('投料订单')">导出</a-button>
