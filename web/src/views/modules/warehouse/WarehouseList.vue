<template>
  <a-card :bordered="false">
          ...
          <template v-if="toggleSearchStatus">
            <a-col :xl="6" :lg="7" :md="8" :sm="24">
              <a-form-item label="仓库类型">
                <j-dict-select-tag placeholder="请选择仓库类型" v-model="queryParam.type" dictCode="material_type"/>
              </a-form-item>
            </a-col>
            <a-col :xl="6" :lg="7" :md="8" :sm="24">
    ...
    <a-tabs defaultActiveKey="1">
      <a-tab-pane tab="库位" key="1" >
        <LocationList :mainId="selectedMainId" />
      </a-tab-pane>
    </a-tabs>
    ...
    data () {
      return {
        ...
        url: {
          ...
          exportXlsUrl: "/warehouse/warehouse/exportXls",
          importExcelUrl: "warehouse/warehouse/importExcel",
        },
        dictOptions:{
         type:[],
         users:[],
    ...
    methods: {
      initDictConfig(){
        ...
        initDictOptions('sys_user,realname,id').then((res) => {
          if (res.success) {
            this.$set(this.dictOptions, 'users', res.result)
          }
        })
      },
