          ...
          <template v-if="toggleSearchStatus">
            ...
            <a-col :xl="6" :lg="7" :md="8" :sm="24">
              <a-form-item label="等级">
                <j-dict-select-tag placeholder="请选择等级" v-model="queryParam.grade" dictCode="supplier_grade"/>
              </a-form-item>
            </a-col>
            <a-col :xl="6" :lg="7" :md="8" :sm="24">
            ...
            <a-col :xl="6" :lg="7" :md="8" :sm="24">
              <a-form-item label="联系人电话">
                <a-input placeholder="请输入联系人电话" v-model="queryParam.telephone"></a-input>
              </a-form-item>
            </a-col>
  ...
  export default {
    ...
    methods: {
      ...
      getSuperFieldList(){
        ...
        fieldList.push({type:'string',value:'grade',text:'等级',dictCode:'supplier_grade'})
        fieldList.push({type:'string',value:'address',text:'地址',dictCode:''})
        fieldList.push({type:'string',value:'contacts',text:'联系人',dictCode:''})
        fieldList.push({type:'string',value:'telephone',text:'联系人电话',dictCode:''})
